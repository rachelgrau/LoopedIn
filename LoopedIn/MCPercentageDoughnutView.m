...
- (void)setDefaults
{
    ...
    self.fillColor                      = [UIColor colorWithRed:(63.f/255.0f) green:(220.f/255.0f) blue:(177.f/255.0f) alpha:(1.0f)];
    ...
    _textLabel.font = [UIFont fontWithName:@"Avenir Book" size:30];
}
